...
public class Shocking6sLTREngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Shocking6sLTREngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Shocking6sLTRIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Shocking6sLTRIW/InitOutcome.xml").getDocumentElement();
